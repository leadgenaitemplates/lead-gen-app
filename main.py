    ...
    try:
        ...
        resend.Emails.send({
            ...
            <div style="font-family:Inter,sans-serif;background:#0f172a;color:white;padding:40px;border-radius:16px;max-width:600px;margin:auto;">
                ...
                <p style="margin-top:25px;color:#94a3b8;">Want weekly auto-updates + priority support? Upgrade to $19/mo by sending payment via x402 — we’ll upgrade you automatically.</p>
        ...
        <p style="margin-top:20px;color:#94a3b8;">Want weekly auto-updates? Send $19/mo via x402 and we’ll upgrade you automatically.</p>
        </body></html>
        """)
    except Exception as e:
        return JSONResponse(status_code=500, content={"error": str(e)})

# (The rest of the file — dashboard, generate, agent-pay, health — is unchanged from your last working version. You can keep your existing blocks for /dashboard, /generate, etc.)
