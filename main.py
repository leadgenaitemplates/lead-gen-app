...
async def success(session_id: str = None):
    ...
    try:
        ...
        # === BRANDED EMAIL RECEIPT ===
        resend.Emails.send({
            "from": "Evergreen Lead Gen <noreply@evergreenleadgen.ai>",
            "to": email,
        ...
        # Success page (same clean UX you already love)
        ...
        <p>Check your email for the branded receipt + direct link.</p>
...
# (The rest of the file — /agent-pay, /generate with clean HTML + CSV download, /health — stays exactly as in the version you already tested successfully. I kept it short here to save space, but the full working version is in your previous message. Just keep your existing /generate, /agent-pay, etc.)
